...
const { theme } = useTheme()
  ...
  return (
    <div className={`border border-border dark:border-dark-border bg-card dark:bg-dark-card rounded-lg p-6 col-span-1 lg:col-span-2`}>
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-foreground dark:text-dark-foreground">Revenue Over Time</h2>
        <p className="text-sm text-muted-foreground dark:text-dark-muted-foreground">Monthly revenue data</p>
      </div>
